...
from tools.data import save_results,train_generator
...
gen = train_generator(batch_size = 1,train_path = test_dir,image_folder = 'images',mask_folder='masks_dilate',target_size=img_size)

eval = unet.evaluate_generator(gen,steps=len(os.listdir(SETTINGS_JSON['TEST_IMAGES_DIR_SEGMENTATION'])),verbose=1)
