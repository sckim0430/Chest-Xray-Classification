...
model_checkpoint = ModelCheckpoint(filepath=model_path, monitor='val_loss',verbose=1)
...
unet.fit_generator(
    generator = train_gen,
    steps_per_epoch= len(os.listdir(os.path.join(train_path,'images')))//batch_size,
    epochs = 200,
