...
def train(train_df, valid_df, model_name, input_size,
    ...
    AUGMENTATIONS_TRAIN = Compose([
        ...
        RandomSizedCrop(min_max_height=(int(input_size*0.75), input_size),
                        height=input_size, width=input_size, p=0.25),
        OneOf([
...
model_densenet, multi_model_densenet = get_multi_model(
    DenseNet169, 0, (input_size_densenet, input_size_densenet, 3), PARAMS_JSON['CLASS_NUM'], lr=1e-3, dropout=0.2)
