...
def train(train_df, valid_df,
    ...
    #get class weight
    class_weight_dict = CalculateClassWeight(
        train_df, PARAMS_JSON['CLASS_NUM'], to_categori)
    ...
    reduceLR = ReduceLROnPlateau(
        monitor='val_loss', factor=0.5, mode=min, patience=5)
...
model_eff, multi_model_eff = get_eff_multi_model(
    eff, 0, (input_size_eff, input_size_eff, 3), PARAMS_JSON['CLASS_NUM'], lr=1e-3, dropout=0.2)
